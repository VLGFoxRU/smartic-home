...
func main() {
	...
	deviceHandler := handler.NewDeviceHandler(deviceSvc, controlSvc, cacheRepo)
	...
	// Telemetry
	api.HandleFunc("/telemetry/{id}/latest", telemetryHandler.GetLatestTelemetry).Methods("GET")
